...
You must duplicate and edit the <tt>test/remote_notifications/remote_hosts_example.yml</tt> file to <tt>remote_hosts.yml</tt> and edit the YAML file for valid hosts. Then you can test sending notifications to remote hosts.
